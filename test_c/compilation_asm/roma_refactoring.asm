...
__LBB0_289:                             # %for.body4.preheader.i
                                        ...
                                        #         Child Loop BB0_339 Depth 4
                                        #           Child Loop BB0_340 Depth 5
	lsw	r4, -32                         # 2-byte Folded Reload
...
__LBB0_350:                             # %if.end.i165.i
	...
	movens	r6, r0
	beq	__LBB0_352
# %bb.351:                              # %if.end.i165.i
                                        #   in Loop: Header=BB0_339 Depth=4
	movens	r2, r0
__LBB0_352:                             # %for.inc44.i
                                        #   in Loop: Header=BB0_339 Depth=4
	ldi	r1, -1
	cmp	r4, r1
	movens	r6, r1
...
__LBB0_309:                             # %if.else49.i.i55.2
	...
	bhi	__LBB0_312
	br	__LBB0_310
__LBB0_310:                             # %if.else49.i.i55.2
                                        #   in Loop: Header=BB0_290 Depth=3
	lsw	r2, -20                         # 2-byte Folded Reload
	cmp	r2, r1
	bhi	__LBB0_312
	br	__LBB0_311
__LBB0_311:                             # %cleanup72.i.i67.2
                                        #   in Loop: Header=BB0_290 Depth=3
...
__LBB0_319:                             # %for.inc.i.2
	...
	beq	__LBB0_325
	br	__LBB0_320
__LBB0_320:                             # %if.end.i.i52.3
                                        #   in Loop: Header=BB0_290 Depth=3
	lsw	r1, -12                         # 2-byte Folded Reload
	shl	r1, r1, 1
	lsw	r4, -54                         # 2-byte Folded Reload
	shl	r4, r4, 4
	add r4, r1, r1
	ldi	r4, state_matrix
	ldw	r1, r4, r1
...
__LBB0_373:                             # %if.then61.i
	...
	movens	r6, r5
	ldi	r6, -128
__LBB0_374:                             # %bot_first_move.exit
                                        #   in Loop: Header=BB0_2 Depth=1
	ldw	r3, r1
	ldi	r3, -2
	and r1, r3, r1
...
__LBB0_381:                             # %if.then.i94
	...
	blt	__LBB0_407
	br	__LBB0_382
__LBB0_382:                             # %if.then.i94
                                        #   in Loop: Header=BB0_378 Depth=3
	ldi	r2, 7
	cmp	r1, r2
	bgt	__LBB0_407
	br	__LBB0_383
__LBB0_383:                             # %if.end.i.i102
                                        #   in Loop: Header=BB0_378 Depth=3
	shl	r1, r2, 1
	shl	r0, r3, 4
	add r3, r2, r2
...
__LBB0_385:                             # %if.then53.i.i105
	...
	blt	__LBB0_407
	br	__LBB0_386
__LBB0_386:                             # %if.then53.i.i105
                                        #   in Loop: Header=BB0_378 Depth=3
	ldi	r2, 7
	cmp	r1, r2
	bgt	__LBB0_407
	br	__LBB0_387
__LBB0_387:                             # %cleanup72.i.i113
                                        #   in Loop: Header=BB0_378 Depth=3
	shl	r1, r1, 1
	shl	r0, r0, 4
	add r0, r1, r0
	...
	bne	__LBB0_407
	br	__LBB0_388
__LBB0_379:                             # %while.cond.i.i75.preheader
                                        #   in Loop: Header=BB0_378 Depth=3
	lsw	r0, -16                         # 2-byte Folded Reload
	add r0, r5, r0
	shl	r0, r1, 1
	...
	br	__LBB0_391
__LBB0_391:                             # %while.cond.i.i75
                                        #   Parent Loop BB0_2 Depth=1
                                        #     Parent Loop BB0_377 Depth=2
                                        #       Parent Loop BB0_378 Depth=3
...
__LBB0_394:                             # %if.end.i35.i
	...
	beq	__LBB0_407
	br	__LBB0_395
__LBB0_395:                             # %if.end.i35.i
                                        #   in Loop: Header=BB0_391 Depth=4
	ldi	r0, 4
	cmp	r3, r0
	beq	__LBB0_407
	br	__LBB0_396
__LBB0_396:                             # %if.end14.i.i87
                                        #   in Loop: Header=BB0_391 Depth=4
	lsw	r0, -8                          # 2-byte Folded Reload
	add r1, r0, r1
	add r2, r4, r2
...
__LBB0_388:                             # %cleanup.thread.i
	...
	ldi	r3, 4
	beq	__LBB0_390
# %bb.389:                              # %cleanup.thread.i
                                        #   in Loop: Header=BB0_377 Depth=2
	ldi	r3, 2
__LBB0_390:                             # %cleanup.thread.i
                                        #   in Loop: Header=BB0_377 Depth=2
	shl	r1, r2, 1
	shl	r0, r4, 4
	add r4, r2, r2
...
__LBB0_190:                             # %if.then.i80.i
	...
	movens	r6, r1
	br	__LBB0_410
__LBB0_361:                             # %cleanup46.i
                                        #   in Loop: Header=BB0_2 Depth=1
	lsw	r4, -50                         # 2-byte Folded Reload
	stw	r4, r3
	ldi	r4, index_to_cell.cell_map
	movens	r4, r5
	...
	movens	r1, r0
	br	__LBB0_374
__LBB0_375:                             # %bot_first_move.exit.if.else9_crit_edge
                                        #   in Loop: Header=BB0_2 Depth=1
	ldi	r1, count_moves_no_takes
	ldw	r1, r2
	br	__LBB0_409
...
__LBB1_79:                              # %if.then13.i149
	...
	movens	r4, r1
	beq	__LBB1_81
# %bb.80:                               # %if.then13.i149
                                        #   in Loop: Header=BB1_2 Depth=2
	movens	r6, r1
__LBB1_81:                              # %if.then13.i149
                                        #   in Loop: Header=BB1_2 Depth=2
	ldi	r0, 2
	lsw	r3, -32                         # 2-byte Folded Reload
	cmp	r3, r0
	...
	lsw	r5, -20                         # 2-byte Folded Reload
	beq	__LBB1_83
# %bb.82:                               # %if.then13.i149
                                        #   in Loop: Header=BB1_2 Depth=2
	movens	r6, r0
__LBB1_83:                              # %if.then13.i149
                                        #   in Loop: Header=BB1_2 Depth=2
	ldi	r3, 2
	cmp	r5, r3
	movens	r4, r3
	beq	__LBB1_85
# %bb.84:                               # %if.then13.i149
                                        #   in Loop: Header=BB1_2 Depth=2
	movens	r6, r3
__LBB1_85:                              # %if.then13.i149
                                        #   in Loop: Header=BB1_2 Depth=2
	cmp	r5, r4
	movens	r4, r5
	beq	__LBB1_87
# %bb.86:                               # %if.then13.i149
                                        #   in Loop: Header=BB1_2 Depth=2
	movens	r6, r5
__LBB1_87:                              # %if.then13.i149
	...
	bne	__LBB1_101
	br	__LBB1_88
__LBB1_88:                              # %if.then13.i149
                                        #   in Loop: Header=BB1_2 Depth=2
	and r1, r5, r0
	tst	r0
	bne	__LBB1_101
	br	__LBB1_112
__LBB1_96:                              # %if.else49.i122
                                        #   in Loop: Header=BB1_2 Depth=2
	and r3, r2, r0
	cmp	r0, r4
	lsw	r5, -18                         # 2-byte Folded Reload
...
__LBB1_100:                             # %cleanup72.i134
	...
	beq	__LBB1_103
	br	__LBB1_101
__LBB1_101:                             # %if.then25
                                        #   in Loop: Header=BB1_2 Depth=2
	ldi	r0, -6
	stw	r0, r4
	ldi	r0, 50
	ldi	r2, seed
__LBB1_102:                             # %for.body.i159
                                        #   Parent Loop BB1_1 Depth=1
                                        #     Parent Loop BB1_2 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	ldw	r2, r1
...
__LBB1_71:                              # %execute_move.exit
	...
	ldi	r3, delta_row
	br	__LBB1_1
__LBB1_103:                             # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	ssw	r3, -34                         # 2-byte Folded Spill
	lsw	r0, -26                         # 2-byte Folded Reload
	stw	r0, r6
	...
	ldi	r0, 3
	beq	__LBB1_105
# %bb.104:                              # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	movens	r2, r0
__LBB1_105:                             # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	lsw	r1, -8                          # 2-byte Folded Reload
	cmp	r1, r6
	beq	__LBB1_107
# %bb.106:                              # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	movens	r2, r0
__LBB1_107:                             # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	ldi	r1, 2
	cmp	r0, r1
	ldi	r1, 4
	movens	r1, r3
	beq	__LBB1_109
# %bb.108:                              # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	movens	r0, r3
__LBB1_109:                             # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	ldi	r2, 7
	lsw	r5, -8                          # 2-byte Folded Reload
	cmp	r5, r2
	beq	__LBB1_111
# %bb.110:                              # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	movens	r0, r3
__LBB1_111:                             # %for.cond.preheader.i171
                                        #   in Loop: Header=BB1_1 Depth=1
	lsw	r5, -18                         # 2-byte Folded Reload
	shl	r5, r0, 1
	lsw	r1, -8                          # 2-byte Folded Reload
...
__LBB1_121:                             # %cleanup30.thread
	...
	cmp	r1, r6
	bne	__LBB1_123
# %bb.122:                              # %cleanup30.thread
                                        #   in Loop: Header=BB1_1 Depth=1
	lsw	r5, -22                         # 2-byte Folded Reload
__LBB1_123:                             # %cleanup30.thread
                                        #   in Loop: Header=BB1_1 Depth=1
	lsw	r1, -34                         # 2-byte Folded Reload
	cmp	r1, r6
	movens	r4, r3
	...
	ldi	r2, seed
	bne	__LBB1_125
# %bb.124:                              # %cleanup30.thread
                                        #   in Loop: Header=BB1_1 Depth=1
	movens	r6, r3
__LBB1_125:                             # %cleanup30.thread
                                        #   in Loop: Header=BB1_1 Depth=1
	ssw	r3, -8                          # 2-byte Folded Spill
	ldi	r0, 14
	ldi	r3, delta_row
