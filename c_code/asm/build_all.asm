...
__LBB13_9:                              # %while.end
	...
	rts
                                        # -- End function
level_safe_move>                        # -- Begin function level_safe_move
# %bb.0:                                # %entry
	push	fp
	ldsp	fp
	addsp	-18
...
__LBB14_10:                             # %if.then25
	...
	bhi	__LBB14_14
	br	__LBB14_11
__LBB14_11:                             # %if.then25
	sub r1, r2, r1
	ldi	r2, 0
	cmp	r1, r2
	blt	__LBB14_14
	br	__LBB14_12
__LBB14_12:                             # %if.then25
	cmp	r1, r0
	bgt	__LBB14_14
	br	__LBB14_13
__LBB14_13:                             # %if.then37
	shl	r1, r0, 1
	shl	r3, r1, 4
	add r1, r0, r0
	ldi	r1, state_matrix
...
__LBB14_14:                             # %if.end50
	...
	beq	__LBB14_44
	br	__LBB14_15
__LBB14_15:                             # %for.cond60.preheader.preheader
	lsw	r3, -10                         # 2-byte Folded Reload
	add	r3, 1
	ldi	r1, 1
	lsw	r2, -8                          # 2-byte Folded Reload
	...
	movens	r1, r2
	beq	__LBB14_17
# %bb.16:                               # %for.cond60.preheader.preheader
	movens	r0, r2
__LBB14_17:                             # %for.cond60.preheader.preheader
	add	r6, 1
	lsw	r4, -12                         # 2-byte Folded Reload
	cmp	r6, r4
	beq	__LBB14_19
# %bb.18:                               # %for.cond60.preheader.preheader
	movens	r0, r1
__LBB14_19:                             # %for.cond60.preheader.preheader
	and r1, r2, r0
	shl	r3, r1, 1
	ssw	r1, -18                         # 2-byte Folded Spill
	shl	r6, r1, 4
	...
	bne	__LBB14_21
	br	__LBB14_20
__LBB14_20:                             # %for.cond60.preheader.preheader
	lsw	r0, -16                         # 2-byte Folded Reload
	...
	bne	__LBB14_22
	br	__LBB14_21
__LBB14_21:                             # %cleanup90
	lsw	r0, -14                         # 2-byte Folded Reload
	shl	r0, r0, 4
	lsw	r1, -10                         # 2-byte Folded Reload
	shl	r1, r1, 1
	add r1, r0, r0
	ldi	r1, state_matrix-2
	ldw	r0, r1, r0
	ldi	r1, -3
	and r0, r1, r0
	ldi	r2, 1
...
__LBB14_34:                             # %for.inc.1
	...
	bne	__LBB14_36
	br	__LBB14_35
__LBB14_35:                             # %cleanup90.1196
	lsw	r1, -10                         # 2-byte Folded Reload
	shl	r1, r1, 1
	lsw	r2, -16                         # 2-byte Folded Reload
	add r1, r2, r1
	ldi	r2, state_matrix-2
	ldw	r1, r2, r1
	ldi	r2, -3
	and r1, r2, r1
	ldi	r2, 1
...
# %bb.39:                               # %for.inc.1198
	movens	r2, r1
__LBB14_40:                             # %for.inc.1198
	and r1, r3, r1
	tst	r1
	bne	__LBB14_42
	br	__LBB14_41
__LBB14_41:                             # %for.inc.1198
	add r0, r6, r0
	ldi	r1, state_matrix
	ldw	r0, r1, r0
	ldi	r1, 0
...
__LBB15_5:                              # %for.body4
	...
	bne	__LBB15_26
	br	__LBB15_6
__LBB15_6:                              # %for.body50.preheader
                                        #   in Loop: Header=BB15_4 Depth=2
	ldi	r4, 3
	br	__LBB15_17
__LBB15_24:                             # %if.else78
...
__LBB15_20:                             # %if.then62
	...
	beq	__LBB15_23
	br	__LBB15_21
__LBB15_21:                             # %if.then62
                                        #   in Loop: Header=BB15_17 Depth=3
	ldi	r1, 2
	cmp	r0, r1
	bne	__LBB15_24
	br	__LBB15_22
__LBB15_22:                             # %if.then66
                                        #   in Loop: Header=BB15_17 Depth=3
	lsw	r2, -12                         # 2-byte Folded Reload
	shl	r2, r0, 1
	ldi	r1, x_safe
...
__LBB15_11:                             # %if.then17
	...
	beq	__LBB15_14
	br	__LBB15_12
__LBB15_12:                             # %if.then17
                                        #   in Loop: Header=BB15_8 Depth=3
	ldi	r1, 2
	cmp	r0, r1
	bne	__LBB15_15
	br	__LBB15_13
__LBB15_13:                             # %if.then20
                                        #   in Loop: Header=BB15_8 Depth=3
	lsw	r2, -12                         # 2-byte Folded Reload
	shl	r2, r0, 1
	ldi	r1, x_safe
...
__LBB15_1:                              # %for.cond.cleanup
	...
	bgt	__LBB15_27
	br	__LBB15_36
__LBB15_27:                             # %if.then98
	ldi	r0, 1
	cmp	r5, r0
	beq	__LBB15_35
	br	__LBB15_28
__LBB15_28:                             # %if.else.i
	ldi	r0, 3
	ldi	r1, 4
	cmp	r5, r1
	blo	__LBB15_33
	br	__LBB15_29
__LBB15_29:                             # %if.else5.i
	ldi	r0, 7
	ldi	r1, 8
	cmp	r5, r1
	blo	__LBB15_33
	br	__LBB15_30
__LBB15_30:                             # %if.else8.i
	ldi	r0, 15
	ldi	r1, 16
	cmp	r5, r1
	blo	__LBB15_33
	br	__LBB15_31
__LBB15_31:                             # %if.else11.i
	ldi	r0, 63
	ldi	r1, 31
	cmp	r5, r1
	bhi	__LBB15_33
# %bb.32:                               # %if.else11.i
	movens	r1, r0
__LBB15_33:                             # %if.end19.i
	ldi	r1, seed
__LBB15_34:                             # %while.cond.i
                                        # =>This Inner Loop Header: Depth=1
	ldw	r1, r2
	shl	r2, r2, 7
	ldw	r1, r3
...
__LBB15_35:                             # %get_rand.exit
	...
	ldw	r4, r5, r4
	br	__LBB15_83
__LBB15_36:                             # %if.else105
	lsw	r5, -10                         # 2-byte Folded Reload
	cmp	r5, r6
	blt	__LBB15_46
	br	__LBB15_37
__LBB15_37:                             # %if.then107
	ldi	r0, 1
	cmp	r5, r0
	beq	__LBB15_45
	br	__LBB15_38
__LBB15_38:                             # %if.else.i206
	ldi	r0, 3
	ldi	r1, 4
	cmp	r5, r1
	blo	__LBB15_43
	br	__LBB15_39
__LBB15_39:                             # %if.else5.i208
	ldi	r0, 7
	ldi	r1, 8
	cmp	r5, r1
	blo	__LBB15_43
	br	__LBB15_40
__LBB15_40:                             # %if.else8.i210
	ldi	r0, 15
	ldi	r1, 16
	cmp	r5, r1
	blo	__LBB15_43
	br	__LBB15_41
__LBB15_41:                             # %if.else11.i212
	ldi	r0, 63
	ldi	r1, 31
	cmp	r5, r1
	bhi	__LBB15_43
# %bb.42:                               # %if.else11.i212
	movens	r1, r0
__LBB15_43:                             # %if.end19.i215
	ldi	r1, seed
__LBB15_44:                             # %while.cond.i217
                                        # =>This Inner Loop Header: Depth=1
	ldw	r1, r2
	shl	r2, r2, 7
	ldw	r1, r3
...
__LBB15_45:                             # %get_rand.exit228
	...
	jsr	execute_move
	br	__LBB15_83
__LBB15_46:                             # %if.else113
	lsw	r4, -12                         # 2-byte Folded Reload
	cmp	r4, r6
	blt	__LBB15_64
	br	__LBB15_47
__LBB15_47:                             # %if.then115
	ldi	r0, 1
	cmp	r4, r0
	beq	__LBB15_55
	br	__LBB15_48
__LBB15_48:                             # %if.else.i232
	ldi	r1, 3
	ldi	r0, 4
	cmp	r4, r0
	blo	__LBB15_53
	br	__LBB15_49
__LBB15_49:                             # %if.else5.i234
	ldi	r1, 7
	ldi	r0, 8
	cmp	r4, r0
	blo	__LBB15_53
	br	__LBB15_50
__LBB15_50:                             # %if.else8.i236
	ldi	r1, 15
	ldi	r0, 16
	cmp	r4, r0
	blo	__LBB15_53
	br	__LBB15_51
__LBB15_51:                             # %if.else11.i238
	ldi	r1, 63
	ldi	r0, 31
	cmp	r4, r0
	bhi	__LBB15_53
# %bb.52:                               # %if.else11.i238
	movens	r0, r1
__LBB15_53:                             # %if.end19.i241
	ldi	r0, seed
__LBB15_54:                             # %while.cond.i243
                                        # =>This Inner Loop Header: Depth=1
	ldw	r0, r2
	shl	r2, r2, 7
	ldw	r0, r3
...
__LBB15_55:                             # %get_rand.exit254
	...
	cmp	r6, r3
	beq	__LBB15_57
# %bb.56:                               # %get_rand.exit254
	movens	r6, r5
__LBB15_57:                             # %get_rand.exit254
	ldi	r3, 0
	cmp	r1, r3
	beq	__LBB15_59
# %bb.58:                               # %get_rand.exit254
	movens	r6, r5
__LBB15_59:                             # %get_rand.exit254
	ldi	r6, delta_column
	ldw	r4, r6, r6
	ldi	r4, state_matrix
	stw	r0, r4, r3
	...
	cmp	r5, r4
	beq	__LBB15_61
# %bb.60:                               # %get_rand.exit254
	movens	r5, r3
__LBB15_61:                             # %get_rand.exit254
	ldi	r4, 7
	cmp	r1, r4
	beq	__LBB15_63
# %bb.62:                               # %get_rand.exit254
	movens	r5, r3
__LBB15_63:                             # %get_rand.exit254
	add r6, r2, r2
	shl	r2, r4, 1
	shl	r1, r5, 4
	add r5, r4, r4
	...
	ldi	r4, 1
	br	__LBB15_83
__LBB15_64:                             # %if.else121
	lsw	r4, -14                         # 2-byte Folded Reload
	cmp	r4, r6
	blt	__LBB15_82
	br	__LBB15_65
__LBB15_65:                             # %if.then123
	ldi	r5, 1
	cmp	r4, r5
	beq	__LBB15_73
	br	__LBB15_66
__LBB15_66:                             # %if.else.i261
	ldi	r1, 3
	ldi	r0, 4
	cmp	r4, r0
	blo	__LBB15_71
	br	__LBB15_67
__LBB15_67:                             # %if.else5.i263
	ldi	r0, 8
	cmp	r4, r0
	ldi	r1, 7
	blo	__LBB15_71
	br	__LBB15_68
__LBB15_68:                             # %if.else8.i265
	ldi	r1, 15
	ldi	r0, 16
	cmp	r4, r0
	blo	__LBB15_71
	br	__LBB15_69
__LBB15_69:                             # %if.else11.i267
	ldi	r1, 63
	ldi	r0, 31
	cmp	r4, r0
	bhi	__LBB15_71
# %bb.70:                               # %if.else11.i267
	movens	r0, r1
__LBB15_71:                             # %if.end19.i270
	ldi	r0, seed
__LBB15_72:                             # %while.cond.i272
                                        # =>This Inner Loop Header: Depth=1
	ldw	r0, r2
	shl	r2, r2, 7
	ldw	r0, r3
...
__LBB15_73:                             # %get_rand.exit283
	...
	cmp	r6, r5
	beq	__LBB15_75
# %bb.74:                               # %get_rand.exit283
	movens	r6, r3
__LBB15_75:                             # %get_rand.exit283
	ldi	r5, 0
	cmp	r1, r5
	beq	__LBB15_77
# %bb.76:                               # %get_rand.exit283
	movens	r6, r3
__LBB15_77:                             # %get_rand.exit283
	ldi	r6, delta_column
	ldw	r4, r6, r6
	ldi	r4, state_matrix
	stw	r0, r4, r5
	...
	cmp	r3, r4
	beq	__LBB15_79
# %bb.78:                               # %get_rand.exit283
	ssw	r3, -18                         # 2-byte Folded Spill
__LBB15_79:                             # %get_rand.exit283
	ldi	r4, 7
	cmp	r1, r4
	beq	__LBB15_81
# %bb.80:                               # %get_rand.exit283
	ssw	r3, -18                         # 2-byte Folded Spill
__LBB15_81:                             # %get_rand.exit283
	add r6, r2, r2
	shl	r2, r3, 1
	shl	r1, r4, 4
	add r4, r3, r3
...
ways_no_take_blunder>                   # @ways_no_take_blunder
	dc	0                               # 0x0
